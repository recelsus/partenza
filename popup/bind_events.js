...
export function bind_popup_events({
    apply_state,
    refresh_view,
    ...
    document.getElementById("save_sort_button").addEventListener("click", () => {
    ...
    document.getElementById("add_tab_button").addEventListener("click", () => {
